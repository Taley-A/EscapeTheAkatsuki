...
class Enemy {
  ...
  constructor(theRoot, enemySpot) {
    ...
    this.domElement.src = "./images/kunai.png";
    ...
    //Let's make the game harder by increasing the speed every 30 seconds
    theRoot.appendChild(this.domElement);

    console.log(this.seconds);

    // let's increase the speed as the score increases
