...
// HOW to add game over message with button to restart????
//fix the header so it is not too big
//
const END_ALERT = "GAME OVER";

// to keep track of the score later when called
let score = 0;

// Declared to make enemies faster
let seconds = 0;
